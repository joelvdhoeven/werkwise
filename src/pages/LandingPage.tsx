  ...
  return (
    <div className={`min-h-screen transition-colors duration-500 ${isDark ? 'bg-gray-950' : 'bg-white'} overflow-hidden`}>
              ...
              <div className="h-20 sm:h-24 lg:h-28 relative mb-6 flex items-start justify-center lg:justify-start overflow-visible">
                <AnimatePresence mode="wait">
                  <motion.span
                    ...
                    className="absolute text-4xl sm:text-5xl lg:text-6xl font-bold bg-gradient-to-r from-red-600 via-rose-600 to-red-600 bg-clip-text text-transparent pb-4 leading-tight"
                  >
                      ...
                      <motion.button
                        ...
                        className={`w-9 h-9 rounded-lg flex items-center justify-center transition-all cursor-pointer ${
                          activePreviewScreen === i
                            ? 'bg-gradient-to-br from-red-600 to-rose-600 text-white shadow-lg shadow-red-500/30'
                            : isDark
                            ...
                            <div className="flex items-end gap-1 h-10">
                              {[65, 45, 80, 55, 90, 70, 40].map((height, i) => (
                                <motion.div
                                  ...
                                  className={`flex-1 rounded-sm ${i === 4 ? 'bg-gradient-to-t from-red-600 to-rose-600' : isDark ? 'bg-gray-700' : 'bg-gray-200'}`}
                                />
                              ))}
                            </div>
                          </div>
                      ...
                      {activePreviewScreen === 1 && (
                        ...
                        >
                          <div className="flex items-center justify-between mb-4">
                            ...
                            <button className="px-2 py-1 rounded-lg text-xs bg-gradient-to-r from-red-600 to-rose-600 text-white">
                              + Nieuw
                            </button>
                          </div>
                          ...
                          <div className={`mt-3 p-2.5 rounded-xl text-center ${isDark ? 'bg-red-500/10' : 'bg-red-50'}`}>
                            <span className={`text-xs font-medium ${isDark ? 'text-red-400' : 'text-red-600'}`}>Totaal deze week: 32:30 uur</span>
                          </div>
                        </motion.div>
                      )}
                            ...
                            {[
                              ...
                              >
                                <div className={`w-8 h-8 rounded-full flex items-center justify-center text-[11px] font-bold ${
                                  i === 0 ? 'bg-gradient-to-br from-red-600 to-rose-600 text-white' : isDark ? 'bg-gray-700 text-gray-300' : 'bg-gray-200 text-gray-600'
                                }`}>
      ...
      <section className={`py-24 relative overflow-hidden transition-colors duration-500 ${isDark ? 'bg-gray-900' : 'bg-gray-50'}`}>
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className={`absolute top-20 right-0 w-[500px] h-[500px] rounded-full blur-3xl ${isDark ? 'bg-red-900/20' : 'bg-red-100/50'}`} />
          <div className={`absolute bottom-0 left-0 w-[400px] h-[400px] rounded-full blur-3xl ${isDark ? 'bg-rose-900/20' : 'bg-rose-100/50'}`} />
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                  ...
                  className={`p-4 rounded-2xl cursor-pointer transition-all duration-300 ${
                    activeFeature === index
                      ? isDark
                        ...
                        : 'bg-white border border-red-100 shadow-lg shadow-red-100/50'
                      : isDark
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    {activeFeature === index && (
                      <motion.div
                        initial={{ scale: 0 }}
                        animate={{ scale: 1 }}
                        className="w-8 h-8 rounded-full bg-gradient-to-br from-red-600 to-rose-600 flex items-center justify-center"
                      >
            ...
            >
              <AnimatePresence mode="wait">
                ...
                >
                  <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-red-600 to-rose-600 flex items-center justify-center mb-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {steps.map((step, index) => (
              <motion.div
                ...
                className="relative"
              >
                <div className={`text-8xl font-bold absolute -top-4 -left-2 ${isDark ? 'text-gray-800' : 'text-red-100'}`}>{step.num}</div>
                ...
                {index < steps.length - 1 && (
                  <div className="hidden md:block absolute top-12 right-0 translate-x-1/2">
                    <ChevronRight className={`h-8 w-8 ${isDark ? 'text-gray-700' : 'text-red-200'}`} />
                  </div>
                )}
              </motion.div>
            ))}
      ...
      {/* CTA Section */}
      <section className="py-24 bg-gradient-to-br from-red-600 via-red-700 to-rose-700 relative overflow-hidden">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to="/onboarding">
                <Button size="lg" className="bg-white text-red-600 hover:bg-gray-100 shadow-2xl w-full sm:w-auto gap-2">
                  <Sparkles className="h-5 w-5" />
                  Wordt Klant
                </Button>
              </Link>
