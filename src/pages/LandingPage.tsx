    ...
    <div className={`min-h-screen transition-colors duration-500 ${isDark ? 'bg-gray-950' : 'bg-white'} overflow-hidden`}>
      ...
      <nav className={`fixed top-0 left-0 right-0 z-50 transition-colors duration-500 ${
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            >
              <div className="w-8 h-8 bg-gradient-to-br from-indigo-600 to-blue-600 rounded-lg flex items-center justify-center shadow-lg shadow-indigo-500/25">
                <span className="text-white font-bold text-sm">W</span>
              </div>
              <span className="text-xl font-bold bg-gradient-to-r from-indigo-600 via-blue-600 to-indigo-600 bg-clip-text text-transparent">
                WerkWise
              </span>
            </motion.div>
      ...
      <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <div className={`absolute top-60 -left-40 w-80 h-80 rounded-full blur-3xl transition-colors duration-500 ${isDark ? 'bg-blue-900/30' : 'bg-blue-100 opacity-50'}`} />
        </div>
              ...
              <div className="h-20 sm:h-24 lg:h-28 relative mb-6 flex items-start justify-center lg:justify-start overflow-visible">
                <AnimatePresence mode="wait">
                  <motion.span
                    ...
                    className="absolute text-4xl sm:text-5xl lg:text-6xl font-bold bg-gradient-to-r from-indigo-600 via-blue-600 to-indigo-600 bg-clip-text text-transparent pb-4 leading-tight"
                  >
                            ...
                            <div className="flex items-end gap-1 h-10">
                              {[65, 45, 80, 55, 90, 70, 40].map((height, i) => (
                                <motion.div
                                  ...
                                  className={`flex-1 rounded-sm ${i === 4 ? 'bg-gradient-to-t from-indigo-600 to-blue-600' : isDark ? 'bg-gray-700' : 'bg-gray-200'}`}
                                />
                              ))}
                            </div>
                          </div>
                      ...
                      {activePreviewScreen === 1 && (
                        ...
                        >
                          <div className="flex items-center justify-between mb-4">
                            ...
                            <button className="px-2 py-1 rounded-lg text-xs bg-gradient-to-r from-indigo-600 to-blue-600 text-white">
                              + Nieuw
                            </button>
                          </div>
                            ...
                            {[
                              ...
                              >
                                <div className={`w-8 h-8 rounded-full flex items-center justify-center text-[11px] font-bold ${
                                  i === 0 ? 'bg-gradient-to-br from-indigo-600 to-blue-600 text-white' : isDark ? 'bg-gray-700 text-gray-300' : 'bg-gray-200 text-gray-600'
                                }`}>
      ...
      <section className={`py-24 relative overflow-hidden transition-colors duration-500 ${isDark ? 'bg-gray-900' : 'bg-gray-50'}`}>
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <div className={`absolute bottom-0 left-0 w-[400px] h-[400px] rounded-full blur-3xl ${isDark ? 'bg-blue-900/20' : 'bg-blue-100/50'}`} />
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    {activeFeature === index && (
                      <motion.div
                        initial={{ scale: 0 }}
                        animate={{ scale: 1 }}
                        className="w-8 h-8 rounded-full bg-gradient-to-br from-indigo-600 to-blue-600 flex items-center justify-center"
                      >
            ...
            >
              <AnimatePresence mode="wait">
                ...
                >
                  <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-indigo-600 to-blue-600 flex items-center justify-center mb-6">
